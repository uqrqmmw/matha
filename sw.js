...
const SHELL = ['./', 'index.html', 'style.css', 'bank.js', 'practice-bank.js', 'textbook-catalog.js', 'paper-question-crops.js', 'app.js', 'vendor/supabase.js', 'vendor/katex/katex.min.css', 'vendor/katex/katex.min.js', 'vendor/katex/auto-render.min.js', 'manifest.webmanifest', 'icon-192.png', 'icon-512.png'];
const KATEX_FONTS = [
...
self.addEventListener('message', (e) => {
  ...
  const target = e.ports && e.ports[0] ? e.ports[0] : e.source;
  if (target && typeof target.postMessage === 'function') {
    target.postMessage({ type: 'MATHA_APP_VERSION', version: APP_STAMP });
  }
});
