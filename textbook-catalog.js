...
const TEXTBOOK_LIBRARY = {
  ...
  books: [
    ...
    { id:'matha-114-trig-graph', title:'三角函數的圖形與應用', file:'114學測班三角函數的圖形與應用.pdf', pages:222, kind:'chapter', topics:['trig2'], ingestion:'pending-qa', eligibility:'core' },
    ...
    { id:'matha-114-linear-transform', title:'平面線性變換與空間概念', file:'114學測班平面線性變換與空間概念.pdf', pages:238, kind:'chapter', topics:['mat','space'], ingestion:'pending-qa', eligibility:'core' },
    ...
    { id:'matha-114-polynomial-quadratic', title:'多項式運算與一次二次函數', file:'114學測班多項式運算與一次二次函數.pdf', pages:246, kind:'chapter', topics:['poly'], ingestion:'pending-qa', eligibility:'core' },
    ...
    { id:'matha-114-line-inequality', title:'直線與二元一次不等式', file:'114學測班直線與二元一次不等式.pdf', pages:206, kind:'chapter', topics:['line'], ingestion:'pending-qa', eligibility:'core' },
    { id:'matha-114-space-plane-line', title:'空間中的平面與直線', file:'114學測班空間中的平面與直線.pdf', pages:292, kind:'chapter', topics:['space'], ingestion:'pending-qa', eligibility:'core' },
    { id:'matha-114-space-vector', title:'空間向量與三階行列式', file:'114學測班空間向量與三階行列式.pdf', pages:248, kind:'chapter', topics:['vec3','space'], ingestion:'pending-qa', eligibility:'core' },
    ...
    { id:'matha-114-sequence', title:'數列遞迴與級數求和', file:'114學測班數列遞迴與級數求和.pdf', pages:262, kind:'chapter', topics:['seq'], ingestion:'pending-qa', eligibility:'core' },
