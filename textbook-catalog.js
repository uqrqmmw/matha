...
const TEXTBOOK_LIBRARY = {
  ...
  books: [
    ...
    { id:'matha-114-matrix-equation', title:'方程式與矩陣運算', file:'114學測班方程式與矩陣運算.pdf', pages:270, pdfSha256:'5062d01aac75978ac72ceb965d26edfc917bad0fdf42fe129950d5492690a345', kind:'chapter', topics:['mat'], ingestion:'pending-qa', eligibility:'core' },
    ...
    { id:'matha-114-plane-vector', title:'平面向量與內積應用', file:'114學測班平面向量與內積應用.pdf', pages:314, pdfSha256:'98a0d59a05b709976c83c3ea2631aa836a275e2c22fcad3150cf678d1dbca5fa', kind:'chapter', topics:['vec'], ingestion:'pending-qa', eligibility:'core' },
    { id:'matha-114-linear-transform', title:'平面線性變換與空間概念', file:'114學測班平面線性變換與空間概念.pdf', pages:238, pdfSha256:'d4d5b67b68deeefbfac6a95e97062b9c5b85a73cf6f9bef5f2595dc605dd8f7d', kind:'chapter', topics:['mat','splane'], ingestion:'pending-qa', eligibility:'core' },
    ...
    { id:'matha-114-space-vector', title:'空間向量與三階行列式', file:'114學測班空間向量與三階行列式.pdf', pages:248, pdfSha256:'50cadf5ea577f9f702e7c5a6b7c2450152feb9caa39bec76b9f34a5bd8a98bc5', kind:'chapter', topics:['svec','splane'], ingestion:'pending-qa', eligibility:'core' },
    ...
    { id:'matha-114-conditional-probability', title:'條件機率與獨立事件', file:'114學測班條件機率與獨立事件.pdf', pages:240, pdfSha256:'f0c8e72cc88be898859f19455900dd20037fb32819261d87277c59b77293188f', kind:'chapter', topics:['prob'], ingestion:'pending-qa', eligibility:'core' },
